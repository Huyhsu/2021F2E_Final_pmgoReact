...
export function NewBagIcon({ size }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function LoadingIcon({ size }) {
  return (
    <svg
      ...
      width="180px"
      height="180px"
      viewBox="368 368 128 128"
      enable-background="new 368 368 128 128"
      // xml:space="preserve"
    >
      <animateTransform
        fill="remove"
      ...
      ></animateTransform>
      <g>
        <circle fill="none" cx="432" cy="432" r="59.718" />
        <g>
          <path
            fill="#f5fef5"
            d="M453.714,436.445c-2.059,10.107-10.998,17.715-21.714,17.715s-19.655-7.607-21.714-17.715h-30.798
			C381.746,463.47,404.392,484.7,432,484.7c27.608,0,50.255-21.23,52.512-48.255H453.714z"
          />
          <path
            fill="#f5fef5"
            d="M432,416.494c-8.563,0-15.506,6.942-15.506,15.506c0,8.564,6.942,15.506,15.506,15.506
        ...
        <path
          fill="#f5fef5"
          d="M432,409.84c10.716,0,19.655,7.606,21.714,17.715h30.798C482.255,400.53,459.608,379.3,432,379.3
...
export function LoadingSmallIcon({ size }) {
  return (
    <svg
      version="1.1"
      id="ball"
